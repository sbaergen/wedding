...
var RegistryComponent = /** @class */ (function () {
    function RegistryComponent(http, dialog, router, snackBar) {
        ...
        this.editMessage = "";
        this.code = "";
        this.registryUrl = 'http://seanandtiffanie2019.ca/wedding/registryapi/';
        this.contributionUrl = 'http://seanandtiffanie2019.ca/wedding/contributionapi/';
